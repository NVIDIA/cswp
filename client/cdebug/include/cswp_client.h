...
// Client state and transport functions
...
typedef struct _cswp_client_t {
    ...
    int   (*disconnect)(struct _cswp_client_t* client);
    int   (*send)(struct _cswp_client_t* client, const void* data, size_t size);
    int   (*receive)(struct _cswp_client_t* client, void* data, size_t size, size_t* used);
    int   (*receive_async)(struct _cswp_client_t* client, void* data, size_t size, size_t* used);
} cswp_client_t;

//------------------------------------------------------------------------------------
// CSWP client command interface functions
//------------------------------------------------------------------------------------
/**
...
/**
 * Convey asynchronous message from device
 *
 * @param client Pointer to cswp_client_t
 * @param deviceNo The device index of the sender
 * @param msg_level Level of message (Error/Warning/Info/Debug) 
 * @param msg Actual message
 * @param msg_size The length of msg string
 */
int cswp_async_message(cswp_client_t* client,
                       varint_t*      deviceNo,
                       varint_t*      msg_level,
                       char*          msg,
                       size_t         msg_size);
 ...
 *
 * @param client Pointer to cswp_client_t
 * @param e Error code to decode
 */
const char *cswp_decode_error(cswp_client_t* client,
                              int e);
#ifdef __cplusplus
}
#endif
