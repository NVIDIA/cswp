...
typedef enum
{
    ...
    CSWP_ASYNC_MSG_LOG          = 0x0004, /**< Client: Response with asyncQ message */
    CSWP_ASYNC_MSG_END          = 0x0005, /**< Client: asyncQ is empty */
    CSWP_NVSEC_TOKEN_REQ_ERR    = 0x0006, /**< Client: NVSEC token error */
    CSWP_NVSEC_SIGNED_TOKEN_ERR = 0x0007, /**< Client: NVSEC token error */
    CSWP_NVSEC_SIGNATURE_ERR    = 0x0008, /**< Client: NVSEC signature error */
    CSWP_NVSEC_PUBLIC_KEY_ERR   = 0x0009, /**< Client:  NVSEC public key error */
    ...
    CSWP_UNEXPECTED_RESPONSE    = 0X0013, /**< Client: Response check failed for response type */
    CSWP_RESPONSE_SIZE_ERR      = 0x0014, /**< Client: Response check failed for size */
...
typedef enum
{
    CSWP_PROTOCOL_v1 = 0x0000000100, // Original
    CSWP_PROTOCOL_v2 = 0x4E56000100  // NVIDIA extension
} cswp_protocol_ver_t;
...
typedef enum
{
    ...
    CSWP_NVSEC_UNLOCK                 = 0x00008000, /**< Unlock server                     NVIDIA EXTENSION command*/
    CSWP_NVSEC_TOKEN                  = 0x00008001, /**< Challenge token                   NVIDIA EXTENSION command */
    CSWP_NVSEC_VERIFY                 = 0x00008002, /**< Verify token                      NVIDIA EXTENSION command */
    CSWP_NVSEC_ENCRYPT                = 0x00008003, /**< Enable encryption of CSWP packets NVIDIA EXTENSION command */
    CSWP_IMPLEMENTATION_DEFINED_END   = 0x0000FFFF, /**< Last implementation defined command */
} cswp_commands_t;

#define CSWP_PROTOCOL_VERSION                1   /**< Protocol version 1 */
#define CSWP_NVSEC_NUM_TOKEN_REQ_BYTES      42   /**< Number of challenge token request bytes sent by PSC-FW */
#define CSWP_NVSEC_NUM_SIGNED_TOKEN_BYTES  252   /**< Number of signed token bytes */

#define CSWP_NVSEC_ECDSA_KEY_STR_SIZE       64   /**< Key used to authenticate server */
#define CSWP_NVSEC_CHALLENGE_STR_SIZE      129   /**< Number of bytes of challenge + 1 for null char */
#define CSWP_NVSEC_SIGNATURE_STR_SIZE      129   /**< Number of bytes of signature + 1 for null char */

#define CSWP_NVSEC_PUBLIC_KEY_STR_SIZES   1025   /**< Number of bytes of public key + 1 for null char */

#define ASYNC_RAS_EVENT                    0x1
#define ASYNC_DBG_PUTS                 0x10000
